  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans">
      ...
      <main className="pt-32 pb-20 px-6 max-w-7xl mx-auto text-left">
        <div className="mb-10"><Link href="/" className="inline-flex items-center gap-2 text-slate-500 hover:text-cyan-400 text-sm font-bold transition-colors"><ChevronLeft className="w-4 h-4" /> GALLERY TOP</Link></div>
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-4"><Heart className="w-5 h-5 text-pink-500 fill-current" /><span className="text-pink-400 text-[10px] font-black uppercase tracking-[0.2em]">Saved Items</span></div>
