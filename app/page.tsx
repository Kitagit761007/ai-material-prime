            ...
            <header className="fixed top-0 left-0 right-0 z-[100] bg-slate-950/80 backdrop-blur-md border-b border-white/5">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <nav className="hidden lg:flex items-center gap-6">
                        ...
                        <Link href="/" className="text-[11px] font-bold text-slate-400 hover:text-cyan-400 transition-colors flex items-center gap-1.5"><LayoutGrid className="w-3 h-3" />カテゴリー</Link>
                        <Link href="/" className="text-[11px] font-bold text-slate-400 hover:text-cyan-400 transition-colors flex items-center gap-1.5"><TagIcon className="w-3 h-3" />タグ一覧</Link>
                        <Link href="/" className="text-[11px] font-bold text-slate-400 hover:text-cyan-400 transition-colors flex items-center gap-1.5"><Heart className="w-3 h-3" />保存済み</Link>
                        <Link href="/" className="text-[11px] font-bold text-slate-400 hover:text-cyan-400 transition-colors flex items-center gap-1.5"><MessageSquare className="w-3 h-3" />お問い合わせ</Link>
                    </nav>
            ...
            <main className="pt-16">
                ...
                <div id="gallery-section" className="py-12 bg-slate-900/30">
                    <div className="max-w-7xl mx-auto px-6 mb-12 text-left">
                        <h2 className="text-3xl font-black text-white uppercase italic">Latest Assets / <span className="text-cyan-400 not-italic font-bold">最新アセット</span></h2>
