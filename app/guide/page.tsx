                    ...
                    <section className="bg-slate-900 rounded-2xl p-8 border border-white/10">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-slate-300">A. はい、トリミング、色調補正、テキスト追加など、自由に加工してご利用いただけます。</p>
                            </div>
                            <div>
                                <h3 className="font-bold text-white mb-2">Q. ダウンロード数に制限はありますか？</h3>
                                <p className="text-slate-300">A. いいえ、制限はありません。必要な画像を自由にダウンロードしてください。</p>
                            </div>
                            <div>
                                <h3 className="font-bold text-white mb-2">Q. 商用利用に事前申請は必要ですか？</h3>
                                <p className="text-slate-300">A. いいえ、事前申請や連絡は不要です。自由にご利用ください。</p>
                            </div>
                        </div>
                    </section>
                </div>
